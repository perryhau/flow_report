...
my $mod = 'uccas';
my @mod = qw(uccas1 uccas2 uccas3);
my @mod_date = qw(%Y%m%d_uccas1 %Y%m%d_uccas2 %Y%m%d_uccas3);
...
system "date +%Y%m%d";
system "perl uccas1_flow.pl";
sleep 60;
system "perl uccas2_flow.pl";
sleep 60;
system "perl uccas3_flow.pl";
